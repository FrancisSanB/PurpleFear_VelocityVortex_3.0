...
public class Autonomous4 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        borderColorBlind(9, 11, 1, 4, 1, 1);
        if (x == 1) {
            sleep(1000);
            tankdrive(0.3, 0.3, 600);
            beaconleft.setPosition(0.1);
            sleep(1000);
            tankdrive(-0.3, -0.3, 640);
            resetcolor();
    ...
    private void gyroTurnRed(double angleTurn) throws InterruptedException {
    ...
    private void borderColorBlind(int ColorMin, int ColorMax, int mintwo, int maxtwo, int ColorSensorNumber, int mode) throws InterruptedException {
        ...
        while (opModeIsActive() && Detect == false) {
            ...
            if (mintwo == 69 && maxtwo == 69) {
                ...
                } else if (colornumber >= mintwo && colornumber <= maxtwo) {
                    Detect = true;
